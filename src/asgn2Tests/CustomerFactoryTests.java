...
public class CustomerFactoryTests {
	...
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidNameWhichLengthIsSmallerThan1() throws CustomerException {
		CustomerFactory.getCustomer("PUC", "", "0123456789", 0, 0);
	}
	
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidNameWhichLengthIsBiggerThan20() throws CustomerException {
	...
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidMobileNumberWhichLengthIsNotEqualTo10() throws CustomerException {
		CustomerFactory.getCustomer("PUC", "Name", "01234567890123", 0, 0);
	}
	
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidMobileNumberWhichLengthIsGreaterthan10() throws CustomerException {
		CustomerFactory.getCustomer("PUC", "Name", "01234567890123123123", 0, 0);
	}
	
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidMobileNumberWhichLengthIsSmallerthan10() throws CustomerException {
		CustomerFactory.getCustomer("PUC", "Name", "0123456", 0, 0);
	}
	
	@Test(expected = CustomerException.class)
	public void testCustomerFactoryCreatePickUpCustomerWithInvalidMobileNumberWhichIsNotStartWith0() throws CustomerException {
	...
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDriverDeliveryCustomerWithInvalidYlocationPositiveCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DVC", "richard", "0123456789", 8, 11);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDriverDeliveryCustomerWithInvalidYlocationNegativeCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DVC","richard", "0123456789", 8, -11);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDriverDeliveryCustomerWithInvalidXlocationPositiveCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DVC", "richard", "0123456789", 11, 8);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDriverDeliveryCustomerWithInvalidXlocationNegativeCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DVC", "richard", "0123456789", -11, 8);
	}
	...
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDroneDeliveryCustomerWithInvalidYlocationPositiveCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DNC", "mattw", "0123456789", 8, 11);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDroneDeliveryCustomerWithInvalidYlocationNegativeCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DNC", "mattw", "0123456789", 8, -11);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDroneDeliveryCustomerWithInvalidXlocationPositiveCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DNC", "mattw", "0123456789", 11, 8);
	}
	
	@Test(expected = CustomerException.class)
	public void CustomerFactoryCreateDroneDeliveryCustomerWithInvalidXlocationNegativeCoordinate() throws CustomerException {
		CustomerFactory.getCustomer("DNC", "mattw", "0123456789", -11, 8);
	}
