...
public abstract class Customer {
	...
	public Customer(String name, String mobileNumber, int locationX, int locationY, String type) throws CustomerException{
		...
		if (type == "Pick Up" && locationX != 0){
			throw new CustomerException("When the type is Pick Up, the x location  must to be 0");
		}
		
		
		if (type == "Pick Up"&& locationY != 0){
			throw new CustomerException("When the type is Pick Up,  y location must to be 0");
		}
